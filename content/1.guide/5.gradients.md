...
For building settings UIs or your own rendering, these are exported from every package:
...
import {
  ...
  type GradientName,
  type GradientInput
} from '@fft-visualizer/react'
```
::

The wrappers re-export these from the core for convenience. The `GRADIENT_LUT_SIZE`
