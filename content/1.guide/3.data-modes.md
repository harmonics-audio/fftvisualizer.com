...
fresh array, or call `feedData()` on the component ([Vue](/vue/props#exposed-methods),
[React](/react/props#imperative-handle)), which copies — and in React also skips a render per
frame.
::
